// ==UserScript==
// @name        Dogeware Reborn
// @match       *://krunker.io/*
// @grant       none
// @version     5.0
// @author      Vaibhgamer999
// @description Krunker Hacks Skidded From Krunker Central
    ...
    class DogeWare {
        ...
        initGUI() {
            function createGUIElem(html, _idk, callback) {
                ...
                icon.style.backgroundImage = 'url("https://tse1.mm.bing.net/th?id=OIP.4bLB4DtTITqySCNudSAC5AHaFb&pid=Api")';
        ...
        getGuiHtml() {
            ...
            let html = '<div id="settHolder">\n<img src="https://cdn.discordapp.com/attachments/1153283978875383838/1159487848626536499/Screenshot_2023-10-05-19-07-33-566_com.kiwibrowser.browser.jpg?ex=65313435&is=651ebf35&hm=edd000707291cfd2398ff0fb43ebaf4be2c68abede18dae20851426dafe3eb67&" width="100%">\n';
            ...
            tab(2, () => {
                ...
                builder.checkbox('Skin hack', 'skinHack', 'Free Skins So Use It Xd.');
